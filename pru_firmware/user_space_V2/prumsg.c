...
int main(int argc, char *argv[]) {		// argv es un array de punteros char. Y argc es un entero con el número de punteros (partes del comando).
  int fd, wr, rd, index, val;                 // fd: Valor de retorno de la función open(). Entero que representa
										// el descriptor del archivo. wr: Devuelve si se ha escrito adecuadamente. rd: Devuelve si se ha leído adecuadamente.
